...
你可以使用 `run_command` 工具在终端中执行命令（SRE 运维核心能力）：
...
# CI/CD 配置搜索
find __REPO_DIR__ -name "Dockerfile" -o -name "docker-compose*" -o -name ".github" -type f
rg "deploy\|build\|pipeline" __REPO_DIR__
